...
<div align="center">
  <img src="./assets/images/Captura de tela claro.png" alt="Tela inicial do SpotifyTutor no modo claro, exibindo interface com cards temáticos, barra de navegação superior e cores azul marinho e verde esmeralda. Ambiente limpo e moderno, com tom motivacional." width="45%" />
  <img src="./assets/images/Captura de tela escuro.png" alt="Tela inicial do SpotifyTutor no modo escuro, interface semelhante ao modo claro, porém com fundo escuro e elementos em destaque verde esmeralda. Atmosfera acolhedora e jovem." width="45%" />
</div>
